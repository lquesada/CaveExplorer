...
var (
	...
	FangsModel = &model.NodeSpec{
		Decoder: model.Load(dir, "fangs", assets.Files),
	}
	SmallHornsModel = &model.NodeSpec{
		Decoder: model.Load(dir, "smallhorns", assets.Files),
	}
	MediumHornsModel = &model.NodeSpec{
		Decoder: model.Load(dir, "mediumhorns", assets.Files),
	}
)
